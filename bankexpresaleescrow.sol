...
contract TokenEscrow {
	...
	uint public decimals = 2;
    	uint public totalSupply = 1875000;
	...
	function TokenEscrow() {
		...
		balanceFor[msg.sender] = 1875000; // Give the creator all initial tokens
		
		// Discount policy
		tokenSupplies[0] = TokenSupply(625000, 0, 11428571428571); // First million of tokens will go 11210762331838 wei for 1 token
		tokenSupplies[1] = TokenSupply(625000, 0, 11848341232227); // Second million of tokens will go 12106537530266 wei for 1 token
		tokenSupplies[2] = TokenSupply(625000, 0, 12500000000000); // Third million of tokens will go 13245033112582 wei for 1 token
	}
